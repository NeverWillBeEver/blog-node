...
// 评论模型
const commentSchema = new mongoose.mongoose.Schema({
	// 评论所在的文章 id
...
autoIncrement.initialize(mongoose.mongoose)
// 自增 ID 插件配置
...
// 标签模型
export default mongoose.mongoose.model('Comment', commentSchema);
