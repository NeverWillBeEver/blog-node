...
import TimeAxis from '../models/timeAxis.js';

//获取全部时间轴内容
export const getTimeAxisList = (req, res) => {
...
export const addTimeAxis = (req, res) => {
...
export const updateTimeAxis = (req, res) => {
...
export const delTimeAxis = (req, res) => {
  let { id } = req.body;
...
// 详情
export const getTimeAxisDetail = (req, res) => {
  let { id } = req.body;
